...
class PageMainContent extends __PageElement {
	...
	public function setUIContents($modelFile=NULL) {
		...
		$columnsArray = array(	"authorizations_id" => "Authorization", 
								"description" => "Description");
		
		$columnsJSON = json_encode($columnsArray);

		$str = "";
		$str .= $this->setHeading("List Authorization", $columnsArray, 'CreateAuthorizationList');
		$str .= $this->setDatatableLayout('list-table', $columnsArray);
		$str .= $this->fillupList('list-table', $columnsJSON, $modelFile, 'authorizationlists', 'BrowseAuthorizationList');
		return $str;
	}
