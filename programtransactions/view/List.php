...
class PageMainContent extends __PageElement {
	...
	public function setUIContents($modelFile=NULL) {
		...
		$str = "";
		$str .= $this->setHeading("List Program", $columnsArray, 'CreateProgramTransaction');
		$str .= $this->setDatatableLayout('list-table', $columnsArray);
		$str .= $this->fillupList('list-table', $columnsJSON, $modelFile, 'programtransactions', 'BrowseProgramTransaction');
