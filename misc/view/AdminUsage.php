...
class PageMainContent extends __PageElement {
	...
	public function setUIContents($modelFile=NULL) {
		...
		$str = "";
		$str .= $this->setHeading("Administrative Process");
		$str .= "<p><img src=images/TEMS_Admin_Flow.png></p>";
		$str .= "<p> Version: {$_SESSION['ini']['software']['version']}</p>";
		$str .= "<p>For latest information, features, help and discussions, visit <a href='http://temsonline.com/content/resources'> http://temsonline.com/content/resources<a>.";
